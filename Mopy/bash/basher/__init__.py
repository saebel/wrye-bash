...
class ModList(_ModsUIList):
    ...
    def __toggle_active_msg(self, changes_dict):
        ...
        if masters_activated:
            ...
            msg = _(u'Activating the following plugins caused their masters to be activated')
        elif children_deactivated:
            checklists += [self.__deactivated_key, _(
                u'Wrye Bash automatically deactivates the children of '
                u'deactivated plugins.'),
                           children_deactivated]
            msg = _(
                u'Deactivating the following plugins caused their children '
                u'to be deactivated')
...
class INIPanel(SashPanel):
    ...
    def RefreshIniDetails(self, selected, resetScroll=False):
