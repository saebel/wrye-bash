...
class INIInfo(FileInfo):
    def __init__(self,*args,**kwdargs):
        ...
        self._ini_file = IniFile(self.getPath())
...
class Installer(object):
    ...
    @staticmethod
    def init_attributes_process(): ##: make it return destination !
        ...
        for full,size,crc in self.fileSizeCrcs:
            ...
            if type_ == 2: #--Complex archive
                ...
                if sub not in activeSubs:
                    ...
                    skip = True
                    subList = espmMap[sub] # add sub key to the espmMap
                    if fileLower == u'wizard.txt':
                        ...
                        if file not in subList: subList.append(file)
                    if skip:
                        continue
